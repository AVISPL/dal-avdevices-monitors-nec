...
class NECMultisyncConstants {
    ...
    final static byte[] CMD_GET_POWER = {0x30,0x31,0x44,0x36};//"01D6";
    final static byte[] CMD_SET_POWER = {0x43,0x32,0x30,0x33,0x44,0x36};//"C203D6";
    final static byte[] CMD_SELF_DIAG = {0x42,0x31};//"B1";
    final static byte[] CMD_SET_INPUT = {0x30,0x30,0x36,0x30};//"0060";
    final static byte[] CMD_GET_INPUT = {0x30,0x30,0x36,0x30};//"0060";
    ...
    final static byte[] POWER_ON = {0x30,0x30,0x30,0x31};//"0001";
    final static byte[] POWER_OFF = {0x30,0x30,0x30,0x34};//"0004";
